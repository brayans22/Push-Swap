...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/08 19:44:05 by bsaiago-          #+#    #+#             */
/*   Updated: 2024/01/08 21:39:53 by bsaiago-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	sort_4(t_list **stack_a, t_list **stack_b)
{
	...
	distance_pos_min = get_distance_head_to_index(stack_a, \
			get_min(stack_a, -1));
